...
* **Chart 4 (Parallel Coordinates) & Chart 11 (Radar Chart):** Support multidimensional state comparisons. By normalizing metrics (0–1) and linking them, users can trace how high income (Kuala Lumpur/Selangor) aligns with low birth rates, while rural states (Kelantan) show the opposite. Spoke lines and closed loops make the radar geometry clear.
